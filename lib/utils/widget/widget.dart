...
Widget buildBackButtonSectionMasuk(BuildContext context, String? nomor_urut, SuratMasukModel? suratData) {
  return Container(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    showDetailActionMenuMasuk(context, nomor_urut, suratData);
                  },
                  borderRadius: BorderRadius.circular(16),
                  child: Container(
...
Widget buildBackButtonSectionKeluar(BuildContext context, String? nomor_urut, SuratKeluarModel? suratData) {
  return Container(
    width: double.infinity,
    child: Row(
      children: [
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    showDetailActionMenuKeluar(context, nomor_urut, suratData,);
                  },
                  borderRadius: BorderRadius.circular(16),
                  child: Container(
                    padding: EdgeInsets.all(16),
...
Widget buildMenuActionDisposisiDesktopAdmin(
  BuildContext context,
  TextEditingController nomorUrutController, {
  VoidCallback? onDelete,
  Function(String)? onEditSave, // Tambahin callback untuk save edit
...
Widget buildMenuActionDisposisiDesktopUser(
  BuildContext context,
  TextEditingController nomorUrutController, {
  VoidCallback? onDelete,
  Function(String)? onEditSave, // Tambahin callback untuk save edit
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () {
                  showDetailActionMenuDisposisiDesktopUser(
                    context,
                    onDelete ?? () => showDeleteConfirmationDisposisiAdmin,
                    nomorUrutController,
                    onEditSave: onEditSave, // Pass callback ke dialog
