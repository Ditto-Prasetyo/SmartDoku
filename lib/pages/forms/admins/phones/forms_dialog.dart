                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child: Column(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              controllers['link_scan']!.text.isEmpty
                                                                                  ? 'Pilih File PDF'
                                                                                  : 'File Terpilih',
                                                                              style: TextStyle(
                                                                                color: Colors.white.withValues(
                                                                            ...
                                                                            if (controllers['link_scan']!.text.isNotEmpty) ...[
                                                                              SizedBox(
                                                                                height: 4,
                                                                              ),
                                                                              Text(
                                                                      ...
                                                                      if (controllers['link_scan']!
                                                                          .text
                                                                          .isNotEmpty)
                                                                        IconButton(
                                                                          onPressed: () {
                                                                            controllers['link_scan']!.clear();
                                                                            setStateLocal(
                                                                              () {},
                                                                            );
                                                                          },
                                              ...
                                              onPressed: () async {
                                                if (_formKey.currentState!
                                                  ...
                                                  try {
                                                    ...
                                                    print(
                                                      "[DEBUG] -> [STATUS] :: File Uploaded == $fileUpload",
                                                    );
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child: Column(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              controllers['dok_final']!.text.isEmpty
                                                                                  ? 'Pilih File PDF'
                                                                                  : 'File Terpilih',
                                                                              style: TextStyle(
                                                                                color: Colors.white.withValues(
                                                                            ...
                                                                            if (controllers['dok_final']!.text.isNotEmpty) ...[
                                                                              SizedBox(
                                                                                height: 4,
                                                                              ),
                                                                              Text(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          if (_formKey.currentState!
                                              .validate()) {
                                            try {
                                              showModernUserAddDialog(context);
                                              UserModel?
