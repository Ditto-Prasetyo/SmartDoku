...
class OutgoingLetterPageAdmin extends StatefulWidget {
  ...
  @override
  State<OutgoingLetterPageAdmin> createState() => _OutgoingLetterPageAdmin();
}

class _OutgoingLetterPageAdmin extends State<OutgoingLetterPageAdmin>
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Expanded(
                                  child: MobileRefreshList<SuratKeluarModel?>(
                                    items:
                                        _visibleList, 
                                    hasBaseData: _listSurat
                                        .isNotEmpty, 
                                      ...
                                      return SuratKeluarCard(
                                        ...
                                        onTap: () {
                                          actionAdminKeluar(
                                            ...
                                            context,
                                            items,
                                            (i) => editDokumenAdminKeluar(
                                              context,
                                              index,
                                              items,
                                              refreshState,
                                            ),
                                            (i) => viewDetailAdminKeluar(
                                              context,
                                              index,
                                              items,
                                            ),
