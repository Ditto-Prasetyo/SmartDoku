...
class DispositionLetterUserDesktop extends StatefulWidget {
  ...
  const DispositionLetterUserDesktop({super.key, this.suratData});

  @override
  State<DispositionLetterUserDesktop> createState() =>
      _DispositionLetterUserDesktopState();
}

class _DispositionLetterUserDesktopState
    extends State<DispositionLetterUserDesktop>
  ...
  Widget _buildDisposisiLetter(Animation<double> _cardAnimation) {
    final surat = getDisposisiData();
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Recent activity
                        Expanded(child: _buildDisposisiLetter(_cardAnimation)),
                      ],
                    ),
                  ),
                ),
